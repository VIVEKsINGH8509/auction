...
const Explore = () => {
  ...
  return (
    <Box sx={{ backgroundColor: "primary" }} padding="4rem" width="80vw" display='flex' flexDirection='column' gap='3em'>
      ...
      <Box display="flex" flexDirection="column" gap="3em">
        <Box display="flex" flexDirection="column" gap="2em">
          ...
          <Box display="flex" justifyContent="space-between" >
            <Card sx={{ maxWidth: 220, position:'relative' }} onClick={()=>navigate('/login')}>
              <CardActionArea>
                <CardMedia
                  component="img"
                  height="330"
